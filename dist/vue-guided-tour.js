(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VueGuidedTour = {}, global.Vue));
  ...
  var script$2 = {
    ...
    setup(props, { emit }) {
      ...
      const currentRect = vue.reactive({ ...rectDefault });
      const prevRect = vue.reactive({ ...rectDefault });

      const overlayWrapper = vue.reactive({
        width: 0,
        height: 0,
      });
      const overlaysRef = vue.ref([]);
      ...
      const overlaysRect = vue.reactive(
        Object.fromEntries(
      ...
      const overlaysRectStyle = vue.computed(() => {
        return (key) => {
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock(vue.Teleport, { to: "body" }, [
      vue.createElementVNode("div", vue.mergeProps({ class: "vue-guided-overlay" }, _ctx.$attrs), [
        vue.createElementVNode("div", {
          class: "vgo__wrapper",
          style: vue.normalizeStyle($setup.overlayWrapperStyle)
        }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($setup.overlaysRect, (overlay, key) => {
            ...
            ,
              class: vue.normalizeClass(`vgo__overlay vgo__overlay--${key}`),
              style: vue.normalizeStyle($setup.overlaysRectStyle(key)),
  ...
  var script$1 = {
    ...
    setup(props) {
      ...
      const { rect, position } = vue.toRefs(props);
      const currentPosition = vue.ref(position.value);
      const x = vue.ref(0);
      const y = vue.ref(0);
    ...
    return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      (_ctx.arrow)
        ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: vue.normalizeClass(`vgp__arrow vgp__arrow--${$setup.currentPosition}`),
            style: vue.normalizeStyle($setup.arrowStyle)
          }, null, 6 /* CLASS, STYLE */))
  ...
  function useFocusTrap(target) {
    ...
    var focusableEls = vue.ref([]);

    var onKeyDown = function onKeyDown(event) {
      if (!active.value || !vue.unref(target)) return;
    ...
    var enableTrap = function enableTrap() {
      active.value = true;
      focusableEls.value = getFocusableElements(vue.unref(target));
  ...
  var script = {
    ...
    setup(props, { emit }) {
      ...
      const $vgt = vue.inject("$vgt", {});
      const uid = Math.random().toString(36).substring(2);

      const showPopover = vue.ref(false);

      const currentStepIndex = vue.ref(-1);
      currentStepIndex.value = stepIndex.value;

      const currentStepEl = vue.ref(null);
      const prevEl = vue.ref(null);
      ...
      const isFirstStep = vue.computed(() => {
        return currentStepIndex.value === 0;
      });
      const isLastStep = vue.computed(() => {
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_vgt_overlay = vue.resolveComponent("vgt-overlay");
    const _component_vgt_popover = vue.resolveComponent("vgt-popover");
    ...
    return (vue.openBlock(), vue.createBlock(vue.Teleport, { to: "body" }, [
      vue.createElementVNode("div", vue.mergeProps({
        ...
        (_ctx.useOverlay)
          ? (vue.openBlock(), vue.createBlock(_component_vgt_overlay, vue.mergeProps({
              key: 0,
              ref: "vgtOverlay",
        ...
        (
          ...
          ? (vue.openBlock(), vue.createBlock(vue.Transition, {
              ...
              default: vue.withCtx(() => [
                vue.createVNode(_component_vgt_popover, vue.mergeProps({
                  rect: $setup.currentStepRect,
                  arrow: _ctx.arrow,
                  offset: _ctx.offset,
                  ...
                  default: vue.withCtx(() => [
                    (_ctx.closeBtn)
                      ? vue.renderSlot(_ctx.$slots, "close", { key: 0 }, () => [
                    ...
                    vue.createElementVNode("div", _hoisted_1, [
                      vue.renderSlot(_ctx.$slots, "content", vue.normalizeProps(vue.guardReactiveProps({ stepIndex: $setup.currentStepIndex })), () => [
                        ($setup.currentStep.title)
                          ? (vue.openBlock(), vue.createElementBlock("h3", {
                              key: 0,
                              id: $setup.currentStep.popover['aria-labelledby'],
                              class: "vgt__title"
                            }, vue.toDisplayString($setup.currentStep.title), 9 /* TEXT, PROPS */, _hoisted_2))
                          : vue.createCommentVNode("v-if", true),
                        ($setup.currentStep.content)
                          ? (vue.openBlock(), vue.createElementBlock("div", {
                              ...
                              class: "vgt__content"
                            }, vue.toDisplayString($setup.currentStep.content), 9 /* TEXT, PROPS */, _hoisted_3))
                          : vue.createCommentVNode("v-if", true)
                      ])
                    ]),
                    vue.createElementVNode("div", _hoisted_4, [
                      (_ctx.pagination)
                        ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5, vue.toDisplayString($setup.currentStepIndex + 1) + " / " + vue.toDisplayString(_ctx.steps.length), 1 /* TEXT */))
                        : vue.createCommentVNode("v-if", true),
                      vue.renderSlot(_ctx.$slots, "nav", vue.normalizeProps(vue.guardReactiveProps({ isFirstStep: $setup.isFirstStep, isLastStep: $setup.isLastStep })), () => [
  ...
  exports.VueGuidedOverlay = script$2;
  exports.VueGuidedPopover = script$1;
  exports.VueGuidedTour = script;
  exports["default"] = vgtPlugin;
